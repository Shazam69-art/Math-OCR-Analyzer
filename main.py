...
model = genai.GenerativeModel("gemini-2.5-flash")  # Use 1.5 for better performance, no timeout issues
...
"""
        ...
        async def generate():
            ...
            for chunk in response:
                ...
                yield chunk.text + "\n"
            # Parse after full response
            questions = parse_gemini_response(full_text)
            analysis_questions = questions  # Store globally
            yield json.dumps({"success": True, "questions": questions})  # Final JSON
    ...
    for section in sections:
        ...
        try:
            ...
            for line in lines:
                ...
                elif current_section == "student" and line:
                ...
                elif current_section == "corrected" and line:
