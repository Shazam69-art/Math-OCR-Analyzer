...
async def analyze():
    ...
    try:
        ...
        system_prompt = """
You are a math tutor analyzing student work. Follow these rules STRICTLY:
...
4. Identify mistakes in the student's answer. Provide clear, descriptive explanations in English, with mathematical expressions in MathJax where needed.
5. Provide your own CORRECTED solution in a step-by-step format using MathJax.
...
MISTAKES:
- [Clear English explanation with MathJax if needed]
CORRECTED SOLUTION:
[Step-by-step solution in MathJax]
MATCH: [YES/NO]
---
"""
